import { Text, Image, Card, CardBody, Box, Heading, SimpleGrid, Flex,Container, CardFooter, Button, ButtonGroup, IconButton, useBreakpointValue, Divider, VisuallyHidden  } from '@chakra-ui/react'
                    ...
                    <Card key={proj.title} h='100%' variant={'filled'} bg={'primary_variant'} border={'2px solid black'}>
                        ...
                        <CardFooter p={0}>
                            <ButtonGroup justifyContent={'start'} size={['lg', 'md', 'lg']} w={'100%'} h={'100%'} bg={'primary'} isAttached>
                                ...
                                {
                                    ! (proj.website || proj.github) && <Button /> // No buttons
                                }
                            </ButtonGroup>
                        </CardFooter>
                    </Card>
